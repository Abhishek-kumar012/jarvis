...
def Record_Option(option):
    ...
    VideoFile_name = f'D:\\Recordings\\Recording_vedio-{time_stamp}.mp4'
    AudioFile_name = f'D:\\Recordings\\Recording_audio-{time_stamp}.wav'
    OutputFileName = f'D:\\Recordings\\Screen_Recorder-{time_stamp}.mp4'
    frames=[]
